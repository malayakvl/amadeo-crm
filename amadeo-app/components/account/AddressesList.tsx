                                ...
                                <tr className="whitespace-nowrap" key={address.id}>
                                    ...
                                    <td>
                                        <button
                                            ...
                                            className="cursor-pointer px-4 py-1 text-sm text-blue-600 bg-blue-200 rounded-full mr-1 inline-block">
                                            {t('Edit')}
                                        </button>
                                        <button
                                            onClick={() => {
                                            ...
                                            className="cursor-pointer px-4 py-1 text-sm text-red-400 bg-red-200 rounded-full mr-1 inline-block">
                                            {t('Delete')}
                                        </button>
                                    </td>
                                </tr>
