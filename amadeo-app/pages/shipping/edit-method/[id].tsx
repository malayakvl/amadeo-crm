                ...
                {user.role_id === 3 ? (
                    <Formik
                        ...
                        onSubmit={(values) => {
                            ...
                            dispatch(updateShippingAction(id, formData)).then(() => router.push('/shipping/list'));
                        }}
                        render={(props) => (
                            <form
                    ...
                    />
                        ...
                        <div className="ml-8 w-full p-4 bg-gray-100 rounded-lg shadow-inner">
                            ...
                            <Formik
                                ...
                                onSubmit={(values) =>
                                    dispatch(saveShippingAction(id, values.countries)).then(() => router.push('/shipping/list'))
                                }
                                render={({ values }) => (
                                    <Form>
                                        <FieldArray
