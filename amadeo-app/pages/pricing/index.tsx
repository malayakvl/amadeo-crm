    ...
    return (
        <div
            className={`w-56 p-4 flex flex-col ${
                selected ? 'border-2 rounded-xl border-orange-450' : ''
            }`}>
            <div>
                ...
                <div className="text-4xl font-bold h-20">
                    {price}
                    <span className="text-base">eur/month</span>
                    {sale > 0 && <div className="text-xs font-bold">{sale}% of sale</div>}
                </div>

                <button
                    onClick={onClick}
                    className={`${disabled ? 'disabled-btn' : 'gradient-btn'} w-full mt-7`}>
                    {buttonText}
                </button>
            </div>
        ...
        <div className="text-gray-350 font-medium max-w-[1440px] mx-auto my-16">
            ...
            <div className="mx-auto h-14 w-3/6 flex mt-8 mb-16">
                <input
                    ...
                    type="text"
                />
                <button className="ml-5 gradient-btn w-96">
